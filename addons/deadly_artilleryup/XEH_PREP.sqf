ace_mk6mortar_fnc_handlePlayerVehicleChanged = compile preprocessFileLineNumbers 'deadly_artilleryup\scripts\fnc_handlePlayerVehicleChanged.sqf';
/* ace_mk6mortar_fnc_rangeTableOpen = compile preprocessFileLineNumbers 'deadly_artilleryup\scripts\fnc_rangeTableOpen.sqf';
ace_mk6mortar_fnc_rangeTablePageChange = compile preprocessFileLineNumbers 'deadly_artilleryup\scripts\fnc_rangeTablePageChange.sqf';
