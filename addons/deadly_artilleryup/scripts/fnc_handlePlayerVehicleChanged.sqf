...
private _vehicleName = typeOf _newVehicle;
private _type = getText (configFile >> "CfgVehicles" >> _vehicleName >> "Turrets" >> "MainTurret" >> "turretInfoType");
if (!(_type isEqualTo "ACE_Mk6_RscWeaponRangeArtillery")) exitWith {};
