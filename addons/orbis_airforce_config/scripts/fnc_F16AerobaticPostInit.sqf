...
_vehicle setPylonLoadOut [4, "FIR_Clean_P_1rnd_M", false, []];
_vehicle setPylonLoadOut [5, "FIR_Empty_P_1rnd_M", false, []];
_vehicle setPylonLoadOut [6, "FIR_Empty_P_1rnd_M", false, []];
_vehicle setPylonLoadOut [7, "FIR_Clean_P_1rnd_M", false, []];
