		class UserActions: UserActions {
			class smoke_off {
				...
				hideOnUse = 1;
				radius = 5;
				condition = "(ACE_player in this) && (isEngineOn this) && (this getVariable ['smokeReady', true]) && (this getVariable ['smokeMod', 'off'] != 'off')";
			...
			class smoke_on_white: smoke_off {
				...
				showWindow = 0;
				condition = "(ACE_player in this) && (isEngineOn this)  && (this getVariable ['smokeReady', true]) && (this getVariable ['smokeMod', 'off'] != 'white')";
			...
			class smoke_on_red: smoke_on_white {
				...
				condition = "(ACE_player in this) && (isEngineOn this)  && (this getVariable ['smokeReady', true]) && (this getVariable ['smokeMod', 'off'] != 'red')";
			...
			/* class smoke_on_green: smoke_on_white {
				...
				condition = "(ACE_player in this) && (isEngineOn this)  && (this getVariable ['smokeReady', true]) && (this getVariable ['smokeMod', 'off'] != 'green')";
			...
			class smoke_on_blue: smoke_on_white {
				...
				condition = "(ACE_player in this) && (isEngineOn this)  && (this getVariable ['smokeReady', true]) && (this getVariable ['smokeMod', 'off'] != 'blue')";
