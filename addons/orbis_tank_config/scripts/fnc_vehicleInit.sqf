...
private _magazine = param [1, ""];
private _hasFlag = param [2, false];
private _hasAlert = param [3, false];
...
if (_hasFlag) then {
	...
	private _actionFlagRemove = [
		...
		{(_this select 0) getVariable ["orbis_tank_flagName", ""] != ""},
		{},
		[],
		[0, 0, 0],
		10
	...
	private _actionFlagRed = [
		...
		{(_this select 0) getVariable ["orbis_tank_flagName", ""] != "\A3\Data_F\Flags\Flag_red_CO.paa"},
		{},
		[],
		[0, 0, 0],
		10
	...
	private _actionFlagGreen = [
		...
		{(_this select 0) getVariable ["orbis_tank_flagName", ""] != "\A3\Data_F\Flags\Flag_green_CO.paa"},
		{},
		[],
		[0, 0, 0],
		10
	...
	private _actionFlagBlue = [
		...
		{(_this select 0) getVariable ["orbis_tank_flagName", ""] != "\A3\Data_F\Flags\Flag_blue_CO.paa"},
		{},
		[],
		[0, 0, 0],
		10
	...
	private _actionFlagWhite = [
		...
		{(_this select 0) getVariable ["orbis_tank_flagName", ""] != "\A3\Data_F\Flags\Flag_white_CO.paa"},
		{},
		[],
		[0, 0, 0],
		10
