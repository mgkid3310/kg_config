...
null = [] execVM "orbis_winter_setup\AL_snowstorm\alias_hunt.sqf";
null = [] execvm "orbis_winter_setup\AL_snowstorm\umblator.sqf";
...
if (snow_burst_server_side) then {
	...
	while {al_snowstorm_om} do {
		...
		// [[_dir,dist,_vect],"orbis_winter_setup\AL_snowstorm\rotocol.sqf"] remoteExec ["execVM"];
		[_dir,dist,_vect] execVM "orbis_winter_setup\AL_snowstorm\rotocol.sqf";
		
		_dir_1 = ["x","y"] call BIS_fnc_selectRandom;
		_vect_1 = [0.01,-0.01] call BIS_fnc_selectRandom;
		// [[_dir_1,dist,_vect_1],"orbis_winter_setup\AL_snowstorm\rotocol.sqf"] remoteExec ["execVM"];
		[_dir_1,dist,_vect_1] execVM "orbis_winter_setup\AL_snowstorm\rotocol.sqf";
...
if (snow_burst_client_side) then {
	...
	if (terrain_type_vanilla) then {
		...
		// [[],"orbis_winter_setup\AL_snowstorm\rotocol_client.sqf"] remoteExec ["execVM"];
		[] execVM "orbis_winter_setup\AL_snowstorm\rotocol_client.sqf";
...
// [[],"orbis_winter_setup\AL_snowstorm\alias_snowstorm_effect.sqf"] remoteExec ["execVM",0,true];
[] execVM "orbis_winter_setup\AL_snowstorm\alias_snowstorm_effect.sqf";

if (breath_vapors_units) then 
{
	{
	// [[_x],"orbis_winter_setup\AL_snowstorm\snow_breath.sqf"] remoteExec ["execVM",0,true];
	[_x] execVM "orbis_winter_setup\AL_snowstorm\snow_breath.sqf";
	sleep 0.5
	} forEach allUnits;
};
