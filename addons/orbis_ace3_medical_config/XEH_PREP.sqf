// Original
orbis_fnc_clearExpired = compile preprocessFileLineNumbers "orbis_ace3_medical_config\scripts\fnc_clearExpired.sqf";
orbis_fnc_clearFinished = compile preprocessFileLineNumbers "orbis_ace3_medical_config\scripts\fnc_clearFinished.sqf";
orbis_fnc_treatmentTime = compile preprocessFileLineNumbers "orbis_ace3_medical_config\scripts\fnc_treatmentTime.sqf";

// ACE3 orverload
ace_medical_fnc_isInMedicalVehicle = compile preprocessFileLineNumbers "orbis_ace3_medical_config\scripts\fnc_isInMedicalVehicle_config.sqf";
